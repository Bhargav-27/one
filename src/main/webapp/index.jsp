...
<head>
    ...
    <title>BhargavShop - Latest E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Bhargav<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Awesome Collection in 2025 Version-3</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 BhargavShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
